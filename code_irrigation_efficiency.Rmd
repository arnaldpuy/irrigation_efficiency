...
```{r print_ranges, cache=TRUE, dependson="plot_unc_comparison", fig.height=2.5, fig.width=2.7}
...
```{r plot_sobol, cache=TRUE, dependson=c("extract_sobol"), fig.height=5, fig.width=2.5, dev = "pdf"}
...
```{r jager_merged, cache=TRUE, dependson="extract_jager_indices", dev = "pdf"}
...
```{r merge_indices, cache=TRUE, dependson=c("extract_jager_indices", "plot_sobol"), dev = "pdf", fig.height=3.2, fig.width=5.5}
